...
public class AmortizationScheduleOld {
	...
	public AmortizationScheduleOld(double amount, double interestRate, int years)
	...
	public static void main(String[] args) {
		...
		try {
			AmortizationScheduleOld as = new AmortizationScheduleOld(amount, apr,
					years);
